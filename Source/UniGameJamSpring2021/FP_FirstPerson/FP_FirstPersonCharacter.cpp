...
AFP_FirstPersonCharacter::AFP_FirstPersonCharacter()
{
	...
	// Set Audio
	static ConstructorHelpers::FObjectFinder<USoundCue> footStepsCue(TEXT("'/Game/Sound/Cues/Footsteps'"));
	footStepsSoundCue = footStepsCue.Object;

	footStepsComponent = CreateDefaultSubobject<UAudioComponent>(TEXT("FootStepAudioComp"));
...
void AFP_FirstPersonCharacter::PostInitializeComponents()
{
	Super::PostInitializeComponents();
	if (footStepsSoundCue->IsValidLowLevelFast())
	{
		footStepsComponent->SetSound(footStepsSoundCue);
	}
}
...
void AFP_FirstPersonCharacter::HeadBob()
{
	if (headBob != NULL)
	{
		GetWorld()->GetFirstPlayerController()->PlayerCameraManager->StartMatineeCameraShake(headBob, 1.0f);
	}
}